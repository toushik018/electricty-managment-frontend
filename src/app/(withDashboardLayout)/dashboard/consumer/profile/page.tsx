...
const Profile = () => {
  ...
  return (
    <ProfileContainer>
      ...
      <ProfileCard>
        <ProfileAvatar src={data?.data.profilePhoto} alt={data?.data.name} />
        <ProfileDetails>
      ...
      <Card sx={{ mt: 2 }}>
        <CardContent>
          ...
          <Typography variant="body1">
            <strong>Units Consumed:</strong> {data?.data.unitsConsumed}
          </Typography>
          <Typography variant="body1">
            <strong>Bill Amount:</strong> {data?.data.billAmount}
          </Typography>
        </CardContent>
      </Card>
      <UpdateFormModal
